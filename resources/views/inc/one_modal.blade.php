            ...
            <form action="{{ route('Post') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="text-black bg-white-700 hover:bg-white-800 focus:ring-4 focus:outline-none
                  ...
                  dark:focus:ring-blue-800"
                    ...
                    <label class="text-success" for="float"> Выбор категории</label>
                </div>
                <div
                    class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                    <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                        <label for="texted" class="sr-only">Печать поста</label>
                ...
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                  ...
                  focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700
                  dark:focus:ring-blue-800">Сохранить пост</button>
                  ...
                  dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Закрыть</button>
                </div>
            </form>
        </div>
    </div>
